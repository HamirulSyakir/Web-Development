  ...
  <div class="row">
    ...
    <form action="orders.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="orderdate" type="datetime-local" class="form-control" id="date" placeholder="Day/Month/Year" value="<?php if(isset($_GET['edit'])) echo $editrow['ORDER_DATE']; ?>" required>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("select * from tbl_orders_a189563_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
        $result = $stmt->fetchAll();
      }
      catch(PDOException $e){
