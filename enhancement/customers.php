    ...
    <form action="customers.php" method="post" class="form-horizontal">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="phone" type="text" class="form-control" id="customerphone" placeholder="Phone Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_phone_number']; ?>" required>
        </div>
        </div>
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      ...
      try {
        ...
        $stmt = $conn->prepare("select * from tbl_customers_a189563_pt2 LIMIT $start_from, $per_page");
        $stmt->execute();
