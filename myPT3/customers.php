    ...
    <div class="col-sm-9">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="phone" type="text" class="form-control" id="phonenumber" placeholder="Phone Number" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_customer_phone_number']; ?>" required>
        </div>
        </div>
